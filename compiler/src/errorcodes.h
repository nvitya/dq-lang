...
DEF_DQ_ERR(DQERR_MODULE_ROOT_INVALID,              "ModuleRootInvalid",      "Invalid module root: $1");
...
DEF_DQ_ERR(DQERR_EMBSTR_SIZE_EXPECTED,               "EmbStrSizeExpected",       "embstr size expected, example: embstr(n)");
DEF_DQ_ERR(DQERR_EMBSTR_SIZE_INVALID,                "EmbStrSizeInvalid",        "Invalid embstr size, it must be a positive integer");
DEF_DQ_ERR(DQERR_EMBSTR_CONSTEXPR,                   "EmbStrConstExpr",          "EmbStr constant expression error: string literal expected");
DEF_DQ_ERR(DQERR_EMBSTR_CONVERSION,                  "EmbStrConversion",         "Invalid EmbStr conversion");  // used with custom text
...
DEF_DQ_ERR(DQERR_CDIR_INC_HEADER_INVALID,          "CDirIncHeaderInvalid",   "#include header is invalid after implementation or inside a .dqh file");
DEF_DQ_ERR(DQERR_CDIR_SRCDEP_SYNTAX,               "CDirSrcDepSyntax",       "#srcdep syntax: expected #srcdep \"filename\"");
DEF_DQ_ERR(DQERR_CDIR_SRCDEP_PLACEMENT,            "CDirSrcDepPlacement",    "#srcdep is invalid after implementation");
DEF_DQ_ERR(DQERR_CDIR_SRCDEP_LOADING,              "CDirSrcDepFileLoad",     "Error loading #srcdep file \"$1\"");
