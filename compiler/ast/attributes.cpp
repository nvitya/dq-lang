...
void OAttr::CheckInvalidAttributes(EAttrTarget atarget)
{
  ...
  CheckAttrAllowed(ATTF_USED,     atarget, ATGT_FUNCTION | ATGT_GLOBAL_VAR | ATGT_GLOBAL_CONST);
...
string AttrName(EAttrFlag aflag)
{
  switch (aflag)
  {
    ...
    case ATTF_NOREAD:        return "noread";
    case ATTF_NOWRITE:       return "nowrite";
