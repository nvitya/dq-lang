> **Historical work note — not authoritative.** Current behavior is documented
> in [Declarations and Scope](../../../docs/reference/declarations-and-scope.md)
> and [Modules and Packages](../../../docs/reference/modules-and-packages.md).
