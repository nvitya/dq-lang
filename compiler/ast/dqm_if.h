...
//                                    MAJOR          MINOR
const uint32_t  DQMIF_VERSION      ( (    1 << 16) |    21 );  // generated version
const uint32_t  DQMIF_MIN_VERSION  ( (    1 << 16) |    21 );  // minimal required version
...
TDqmIfRecId  DQMIF_TYPE_SPEC_AUTOFREE_BEGIN  = 0x8040;  // 0: ownership-qualified type wrapper begin
TDqmIfRecId  DQMIF_TYPE_SPEC_AUTOFREE_END    = 0x804F;  // 0
...
TDqmIfRecId  DQMIF_VALUE_EMBSTR_POINTER  = 0x8102;  // str: relocatable ^char string literal
...
TDqmIfRecId  DQMIF_UNION_FWD              = 0x070D;  // str: name
TDqmIfRecId  DQMIF_OBJ_FWD                = 0x070F;  // str: name
TDqmIfRecId  DQMIF_OBJ_BEGIN              = 0x0701;  // str: name
TDqmIfRecId  DQMIF_UNION_BEGIN            = 0x0704;  // str: name
...
TDqmIfRecId  DQMIF_UNION_END              = 0x07FD;  // 0
