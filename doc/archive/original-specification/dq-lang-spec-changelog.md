> **Historical document — not authoritative.** This changelog belongs to the
> obsolete original draft. See the current [coverage inventory](../../../docs/contributing/coverage-inventory.md).

## Appendix B: Changelog

### v0.1.20 (2026-03-11)
- Added p[offs] pointer offset syntax
- Added implicit pointer dereferencing for struct fields: the sp.field same as sp^.field

### v0.1.19 (2026-01-24)
- Added "Assignment Compatibility" rule (Section 3.6) to allow implicit conversion of `char` to `str` on assignment, creating a formal exception to the "no implicit conversions" principle for this common use case.
