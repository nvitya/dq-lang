...
For the self-contained Windows DQ package, the matching Windows-hosted toolchain
...
The compact Linux package omits bundled LLVM tools. The full Linux and Windows
packages include the supported toolchain/runtime payload expected by their
launchers. Package maintainers should follow the clean-environment checks in
[Release and Cross-Build Notes](../contributing/release-and-cross-builds.md).
