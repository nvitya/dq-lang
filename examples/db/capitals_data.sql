-- World capitals test database
-- 195 states: 193 UN member states + Holy See + State of Palestine
-- Dataset prepared September 2026.
--
-- Some countries have unusual/multiple capital arrangements.
-- This test dataset uses one principal/official capital per country.

INSERT INTO capitals (CITY, COUNTRY, CONTINENT) VALUES
    ...
    ('Brazzaville', 'Republic of the Congo', 'Africa'),
    ('Kinshasa', 'Democratic Republic of the Congo', 'Africa'),
    ('Yamoussoukro', 'Côte d''Ivoire', 'Africa'),
