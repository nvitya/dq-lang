> **Historical format design — not current.** Use
> [DQ Module Artifacts](../../../docs/compiler/dqm-format.md) and
> [Module and Interface Internals](../../../docs/contributing/module-and-interface-internals.md).
