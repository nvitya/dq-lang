...
- text: `str`, `rostr`, `strslice`, `embstr(N)`, and unsized `embstr`;
...
Text conversions distinguish ownership and encoding. Passing `str`, `rostr`, `strslice`,
or compatible `embstr` data to a view-style parameter may borrow storage;
